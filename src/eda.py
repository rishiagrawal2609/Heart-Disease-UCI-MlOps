...
def print_summary(df):
    ...
    print("EDA Summary")
    print("="*50)
    print(f"1. Dataset contains {df.shape[0]} samples with {df.shape[1]-1} features and 1 target variable")
    
    target_counts = df['target'].value_counts()
    print(f"2. Class distribution is relatively balanced (ratio: {target_counts[0] / target_counts[1]:.2f})")
