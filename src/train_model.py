...
def train_logistic_regression(X_train, X_test, y_train, y_test, preprocessor):
    ...
    with mlflow.start_run(run_name="Logistic_Regression"):
        ...
        # Evaluate
        metrics, cm_path = evaluate_model(model, X_train, X_test, y_train, y_test, "LogisticRegression")
...
def train_random_forest(X_train, X_test, y_train, y_test, preprocessor):
    ...
    with mlflow.start_run(run_name="Random_Forest"):
        ...
        # Evaluate
        metrics, cm_path = evaluate_model(model, X_train, X_test, y_train, y_test, "RandomForest")
...
def main():
    ...
    lr_model, lr_metrics = train_logistic_regression(X_train, X_test, y_train, y_test, preprocessor)
